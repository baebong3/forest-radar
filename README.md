...
밤 · 호두 · 대추 · 표고버섯 · 떫은감 품목별 월별 수출입 시계열, 연간 생산량, 최근 뉴스 · (주)서던포스트
...
- 탭(종합 · 품목 5개)은 자바스크립트 없이 동작 → 모바일 앱 내 뷰어에서도 열림
...
| 관측 | 한국농촌경제연구원 임업관측 월보(밤 · 표고버섯 · 대추 · 감 · 호두) - 소제목(판단)과 첫 문장(근거), 월별 표(가격 · 수출입)를 2015년 이후 호까지 모아 시계열로 표시 | 매월 4일(품목별 발표 월 상이) | 없음 |
